...
#property copyright "Copyright 2017, AMT Corp"
#property link      "www.AMTCorp.com"
#property version   "2.00"
#property strict
#property description "PowerTool 4 - Triple Timeframes with Multiple Position"
    ...
    if( (NATR * atr_1) > CapOnStopDistancePips * Point * PointToPrice )    // Cap stop distance
      {
        ...
        Print("[Execute_Entry_Sell_PMultiple]:" , 
              ...
              " Ask: " , MarketInfo(Symbol(),MODE_ASK) , " / " , DoubleToStr(Ask , 5) ,
              " Spread: " , MarketInfo(Symbol(),MODE_SPREAD) ,
              " Spread Pips: " ,  DoubleToStr( (Ask-Bid)/(Point * PointToPrice) , 0)
              );
      }
...
void OnTick()
  {
    ...
    */
    ...
    if( IsFirstTick_MTF )
    {
      ...
      // Values are printed on every hour - instead of every 5 minutes !
      // This reduces the line number by nearly a factor of 12
              ...
              )
              {
                ...
                DrawArrowUp("Up"+Bars , Low[1]-10*Point , clrYellow );
                  ...
                  if( HTF_SetupType_2_LONG )
                    Print("[OnTick] > [DrawArrowUp] *** Setup is due to HTF_SetupType_2_LONG ****");
            ...
            if(     slowLR_ABOVE_upperBollingerBand_bar2
              ...
              )
              {
                ...
                if( HTF_SetupType_2_SHORT )
                  Print("[OnTick] > [DrawArrowDown] *** Setup is due to HTF_SetupType_2_SHORT ****");
